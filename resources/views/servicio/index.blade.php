...
<div class="row">
 ...
 <h1>Servicio</h1>
 <a href="{{url('/servicio/create')}}" class="btn btn-success no-pdf">Crear</a>
 ...
 <table class="table table-striped table-bordered table-hover">
     ...
     @foreach ($servicio as $user)
         <tr>
            ...
            <td class="no-sort no-click no-pdf"><a href="{{url('servicio',$user->id)}}" class="btn btn-primary">Ver</a></td>
            <td class="no-sort no-click no-pdf"><a href="{{route('servicio.edit',$user->id)}}" class="btn btn-warning">Actualizar</a></td>
