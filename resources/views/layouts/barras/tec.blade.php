<li><a href="/perfil"><span class="glyphicon glyphicon-user"></span> Perfil de Tecnico</a></li>
<li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
      <li><a href="/servicio"><span class="glyphicon glyphicon-wrench"></span>servicios</a></li>
